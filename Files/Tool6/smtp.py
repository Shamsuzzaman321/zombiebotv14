...
try:
 ...
 ''')
 inputs=open(raw_input('\033[91m[\033[92m+\033[91m]\033[92mEmail List : \033[93m '),'r').read().splitlines()
 ...
 if int(thret)>200:
	thret=200
 print """ \033[93m[\033[91m!\033[93m] Dr HeX SMTP Cracker\n 
 Recoder Mail : %s
